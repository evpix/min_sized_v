...
V compiles to C and by default produces relatively large binaries due to the included runtime, libc linkage, and debug information. With the right flags and techniques, you can significantly reduce the size—from several megabytes down to tens or even single-digit kilobytes.
